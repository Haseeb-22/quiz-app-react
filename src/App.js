...
function App() {
  ...
  // Your Result is {(sorce / quizData.length) * 100}%
  return (
    <div>
      ...
      {/* <Box className="Result" >
        <Typography className=''>Your Sorce is {(sorce / quizData.length) * 100}%</Typography>
        <Typography className=''>Total Time For Quiz {}</Typography>
        <Typography className=''>Quiz Complete In {}</Typography>
      </Box> */}
    </div>
  );
}
